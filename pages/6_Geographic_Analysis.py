...
st.markdown("""
    <h1 style='color:#4da6ff;'>🗺️ Geographic Analysis</h1>
    <div style='background:#1a2035; padding:30px; border-radius:12px;
        ...
        <p style='color:#8899aa; font-size:1.1rem;'>
            Interactive world map with country risk heatmap.<br>
            Click any country for detailed breakdown. Side-by-side country comparison tool.
        </p>
    </div>
